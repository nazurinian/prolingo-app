...
export default function DesktopSystemControls({
  ...
  isBatchDownloading, setIsBatchOpen, isBatchOpen, debugButtonRef,
    ...
    <>
              ...
              <div className="space-y-3 bg-slate-50 dark:bg-slate-700 p-3 rounded-lg border border-slate-100 dark:border-slate-600">
                ...
                {mode === 'table' && <button
                  ...
                  className={`w-full px-2 py-2 rounded-lg border text-[10px] font-black disabled:opacity-50 transition-colors flex items-center justify-center gap-1.5 ${isBatchOpen ? 'bg-purple-600 border-purple-600 text-white' : 'bg-white/80 dark:bg-slate-800 border-purple-200 dark:border-purple-800 text-purple-700 dark:text-purple-300'}`}
                >
              ...
              <div className="space-y-2 bg-slate-50 dark:bg-slate-700 p-3 rounded-lg border border-slate-100 dark:border-slate-600">
                ...
                <button
                  ...
                  className={`w-full px-2 py-2 rounded border text-[10px] font-bold transition-colors ${showLogs ? 'bg-slate-800 border-slate-800 text-white dark:bg-slate-600 dark:border-slate-500' : 'border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300'}`}
