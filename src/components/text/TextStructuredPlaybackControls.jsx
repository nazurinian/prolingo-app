...
export default function TextStructuredPlaybackControls({
  ...
  return <div className="space-y-3" data-text-player-settings="true">
    ...
    <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/40 p-3" data-text-player-show-play="true">
      ...
      <div className="mt-3 mb-1 flex items-center gap-1"><List className="w-3.5 h-3.5 text-indigo-500"/><span className="text-[8px] font-black uppercase text-indigo-600 dark:text-indigo-300">Workspace EN / ID order</span></div>
    ...
    <div className="rounded-xl border border-emerald-100 dark:border-emerald-900 bg-emerald-50/50 dark:bg-emerald-950/20 p-3" data-text-player-behaviour="true">
      <div className="mb-2 flex items-center gap-1.5"><Repeat2 className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-300"/><p className="text-[8px] font-black uppercase text-emerald-700 dark:text-emerald-300">Workspace Playback Behaviour</p></div>
      <div className="grid grid-cols-2 gap-2">
